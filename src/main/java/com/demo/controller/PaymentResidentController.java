...
public class PaymentResidentController {
    ...
    public ResponseEntity<PaymentResidentResponseDTO> findPayment(HttpSession session)
    {
        session.setAttribute("InvoiceResident", paymentResidentService.findPayment());
